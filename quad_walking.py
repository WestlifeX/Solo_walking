...
x_LF   = np.empty((3, N+N_post))*np.nan
dx_LF  = np.empty((3, N+N_post))*np.nan
ddx_LF = np.empty((3, N+N_post))*np.nan
ddx_LF_des = np.empty((3, N+N_post))*np.nan
x_RF   = np.empty((3, N+N_post))*np.nan
dx_RF  = np.empty((3, N+N_post))*np.nan
ddx_RF = np.empty((3, N+N_post))*np.nan
ddx_RF_des = np.empty((3, N+N_post))*np.nan
