...
from LIPM_to_TSID import mpc_to_tsid
from plan_LIPM_talos import run_mpc
...
tsid_data_files = {'mpc': conf.DATA_FILE_TSID_MPC,
                  'rmpc':conf.DATA_FILE_TSID_RMPC,
                  'smpc':conf.DATA_FILE_TSID_SMPC}
for i in tsid_data_files:
    print("".center(conf.LINE_WIDTH,'#'))
    print(" Test Walking mpc vs rmpc vs smpc".center(conf.LINE_WIDTH, '#'))
    print("".center(conf.LINE_WIDTH,'#'), '\n')
    ...
    #                                    LOAD DATA
    #---------------------------------------------------------------------------
    data = np.load(tsid_data_files[i])
    tsid = TsidBiped(conf)
