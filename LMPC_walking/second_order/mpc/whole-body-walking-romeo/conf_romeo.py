...
path = '/home/agazar/LMPC_walking/models/romeo'
...
contactNormal = np.matrix([0., 0., 1.]).T   # direction of contact normal
com_constraint = 0.05
plot_legend = True
...
DISPLAY_N = 20                 # update robot configuration in viwewer
